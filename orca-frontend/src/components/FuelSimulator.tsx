...
export default function FuelSimulator() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-3xl bg-white border border-zinc-200 p-6 md:p-8 shadow-xl text-zinc-900">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-zinc-200 pb-6">
        ...
        <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 border border-zinc-200 text-xs font-mono text-zinc-700">
          <span>V_ground = <strong className="text-blue-600">V_ship + V_current + K_wind·V_wind</strong></span>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-600 font-medium">Voyage Distance:</span>
              <span className="text-zinc-900 font-bold">{distanceNM} Nautical Miles</span>
            </div>
            <input
              type="range"
              min="15"
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              ...
              <span className="text-zinc-900 font-bold">{currentSpeedKnots.toFixed(1)} Knots</span>
            </div>
            <input
              type="range"
              min="0.2"
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono">
              <span className="text-zinc-600 font-medium">Vessel Design Cruise Speed:</span>
              <span className="text-zinc-900 font-bold">{vesselSpeedKnots} Knots</span>
            </div>
            <input
              type="range"
              min="8"
        ...
        <div className="lg:col-span-6 grid grid-cols-2 gap-4">
          <motion.div
            ...
            className="p-6 rounded-2xl bg-blue-50/80 border border-blue-200 col-span-2 shadow-sm"
          >
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono text-blue-700 uppercase font-semibold">Net Fuel Delta Savings</span>
              <Fuel className="w-5 h-5 text-blue-600" />
            </div>
            <div className="text-5xl font-black font-mono text-blue-600 mt-2 tracking-tight">
              {fuelSavingsPercent}%
            </div>
            <p className="text-xs text-zinc-600 mt-1">
              Conserves <strong className="text-zinc-900">{fuelSavedLiters.toFixed(1)} Liters</strong> of marine diesel on this transit alone.
            </p>
          </motion.div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-zinc-200 shadow-xs">
            ...
            <p className="text-[11px] text-zinc-400 mt-0.5">SOG: {effectiveSOG.toFixed(1)} kts</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-zinc-200 shadow-xs">
            ...
            <p className="text-[11px] text-zinc-400 mt-0.5">Direct crew savings</p>
          </div>
        </div>
      </div>
    </div>
