...
const SPECIES_LIST: SpeciesProfile[] = [
  ...
  },
  {
    ...
    localNames: [
      { lang: "Marathi", name: "Tarli" },
      { lang: "Malayalam", name: "Mathi" },
      { lang: "Tamil", name: "Kavalai" },
      { lang: "Kannada", name: "Bhootai" },
      { lang: "Telugu", name: "Kavallu" },
    ],
    category: "coastal",
    iucnStatus: "Least Concern",
    iucnColor: "#228B5A",
    confidence: 95,
    optimalTemp: "26.5°C – 29.5°C",
    optimalSalinity: "32.0 – 34.8 PSU",
    optimalChl: "1.8 – 3.8 mg/m³",
    depthRange: "0m – 35m",
    behavior: "Crucial small pelagic forage fish forming large surface schools. Feeds directly on phytoplankton blooms, particularly Fragilariopsis and Chaetoceros diatoms.",
    gearRecommendation: [
      "Traditional Ring Seine",
      "Surface Drift Gillnets (18–24mm mesh)",
      "Cast Nets in nearshore breakers",
    ],
    mandiRate: [
      { port: "Munambam Harbor (Kerala)", rate: "₹90 – ₹130 / kg", trend: "up" },
      { port: "Malpe Port (Karnataka)", rate: "₹80 – ₹110 / kg", trend: "stable" },
      { port: "Ratnagiri Jetty (Maharashtra)", rate: "₹95 – ₹140 / kg", trend: "up" },
    ],
    solunarPeak: "05:00 – 07:45 IST & 17:15 – 19:30 IST",
    description: "Oil Sardine is the single largest contributor to marine fish landings along the Indian West Coast. Its availability is intimately linked to the onset of the Southwest monsoon upwelling and diatom bloom dynamics.",
    tags: ["Core Forage Biomass", "High Omega-3", "Monsoon Upwelling Indicator"],
  },
  {
    id: "seerfish",
    commonName: "King Seer Fish",
    scientificName: "Scomberomorus commerson",
    localNames: [
      { lang: "Hindi", name: "Surmai" },
      { lang: "Marathi", name: "Surmai" },
      { lang: "Malayalam", name: "Neymeen" },
      { lang: "Tamil", name: "Vanjaram" },
      { lang: "Telugu", name: "Vanjiram" },
    ],
    category: "pelagic",
    iucnStatus: "Near Threatened",
    iucnColor: "#C87B12",
    confidence: 89,
    optimalTemp: "25.5°C – 29.8°C",
    optimalSalinity: "34.0 – 36.2 PSU",
    optimalChl: "0.9 – 2.0 mg/m³",
    depthRange: "15m – 65m",
    behavior: "Solitary or small-pod apex pelagic predator hunting sardines, anchovies, and squids along coastal thermal fronts and reef drop-offs.",
    gearRecommendation: [
      "Large-mesh Drift Gillnet (120–160mm)",
      "Hook-and-Line / Trolling with artificial jigs",
      "Surface Longlines",
    ],
    mandiRate: [
      { port: "Kochi Fishing Harbor (Kerala)", rate: "₹520 – ₹680 / kg", trend: "up" },
      { port: "Sassoon Docks (Mumbai)", rate: "₹550 – ₹720 / kg", trend: "up" },
      { port: "Visakhapatnam Harbor (Andhra)", rate: "₹480 – ₹620 / kg", trend: "stable" },
    ],
    solunarPeak: "04:15 – 06:45 IST & 18:15 – 20:45 IST",
    description: "King Seer Fish (Surmai/Vanjaram) commands the highest domestic fresh market prices in India. Satellite radar SST fronts and bathymetric ridges (30–60m) are prime navigational targets for commercial hook-and-line vessels.",
    tags: ["High Domestic Value", "Prime Table Catch", "Reef & Front Predator"],
  },
];
...
export default function ReportView({
  ...
  if (isGenerating && (!currentReport || !currentReport.sections || currentReport.sections.length === 0)) {
    ...
    return (
      <div id="orca-report-section" className="relative min-h-screen bg-[#F8FAFC] text-[#202124] pb-24 font-sans">
        {/* Sticky Top Bar */}
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#1F4E8C] animate-pulse" />
                <span className="text-xs font-bold font-mono text-[#1F4E8C] tracking-wide uppercase">
            ...
            <div className="flex items-center gap-2 text-xs font-mono text-[#475569]">
              <span className="px-2.5 py-1 rounded-md bg-white border border-[#CBD5E1] shadow-2xs">
                {latDisplay}°N, {lonDisplay}°E
              </span>
              <span className="hidden sm:inline-block px-2.5 py-1 rounded-md bg-white border border-[#CBD5E1] shadow-2xs">
                {basin}
              </span>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <div className="rounded-2xl bg-white border border-[#E1E5EA] shadow-sm p-6 sm:p-8 mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-2 text-xs font-mono font-semibold text-[#1F4E8C] uppercase tracking-wider mb-2">
                  <Cpu className="h-4 w-4 text-[#1F4E8C] animate-spin" />
                ...
                <p className="text-sm text-[#64748B] mt-1">
                  Compiling sovereign oceanographic dossier for target geodetic cell{" "}
                  <span className="font-mono text-[#1F4E8C] font-semibold bg-[#F0F4FA] px-2 py-0.5 rounded border border-[#CBD5E1]">
                    [{latDisplay}°N, {lonDisplay}°E]
                  </span>
                </p>
              </div>
              ...
              <div className="flex sm:flex-col items-end justify-between sm:justify-center">
                ...
                <span className="text-[11px] font-mono text-[#64748B]">Compilation Progress</span>
              </div>
            </div>
            ...
            <div className="w-full bg-slate-100 rounded-full h-3 p-0.5 overflow-hidden border border-slate-200 mb-6">
              <div
                className="bg-gradient-to-r from-[#1F4E8C] via-[#2563EB] to-[#0EA5E9] h-full rounded-full transition-all duration-500 ease-out shadow-xs"
          ...
          <div className="mb-8">
            <h3 className="text-xs font-mono font-semibold uppercase tracking-wider text-[#475569] mb-3 flex items-center gap-2">
              <Activity className="h-3.5 w-3.5 text-[#1F4E8C]" />
                ...
                return (
                  <div
                    ...
                    className={`rounded-xl p-4 border transition-all duration-300 ${
                      isDone
                        ? "bg-white border-emerald-300 shadow-2xs hover:shadow-xs"
                        : isActive
                        ? "bg-[#F0F6FF] border-2 border-[#1F4E8C] ring-2 ring-[#1F4E8C]/15 shadow-xs"
                        : "bg-white border-[#E1E5EA] shadow-2xs hover:border-slate-300"
                    }`}
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className={`text-xs font-bold ${isActive ? "text-[#1F4E8C]" : "text-[#1E293B]"}`}>
                            {agent.title}
                          </div>
                      ...
                      {isDone ? (
                        ...
                        <span className="flex items-center gap-1 text-[10px] font-mono font-bold text-white bg-[#1F4E8C] px-2 py-0.5 rounded-full shadow-xs animate-pulse">
                          <RefreshCw className="h-3 w-3 animate-spin" /> Active
                        </span>
                      ) : (
                        <span className="text-[10px] font-mono font-medium text-slate-500 bg-slate-100 px-2 py-0.5 rounded-full border border-slate-200">
                          Queued
                        </span>
                      )}
                    </div>
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-3.5 rounded-xl border transition-all ${
                      isReady
                        ? "bg-white border-emerald-300 shadow-2xs text-[#1E293B]"
                        : isBuilding
                        ? "bg-[#F0F6FF] border-2 border-[#1F4E8C] ring-2 ring-[#1F4E8C]/15 shadow-xs text-[#1F4E8C]"
                        : "bg-white border-[#E1E5EA] shadow-2xs text-[#64748B]"
                    }`}
                  >
                    <div className="flex items-center gap-2.5">
                      <span className={`font-mono text-xs font-bold ${
                        isReady ? "text-emerald-600" : isBuilding ? "text-[#1F4E8C]" : "text-slate-400"
                      }`}>
                        {sec.num}
                      </span>
                      <span className={`text-xs ${
                        isReady ? "text-[#1E293B] font-medium" : isBuilding ? "text-[#1F4E8C] font-bold" : "text-slate-600"
                      }`}>
                        {sec.label}
                      </span>
                    </div>
                    ...
                    {isReady ? (
                      ...
                      <Sparkles className="h-3.5 w-3.5 text-[#1F4E8C] animate-spin flex-shrink-0" />
                    ) : (
